...
| Material layer | `Forcing/Material/` | material carriers (transitive sets with a membership-only interface), the no-junk internal forcing presentation, and the internal name family (small enumeration, semantic representatives); `M[G]` follows |
