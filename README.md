...
| Material layer | `Forcing/Material/` | material carriers (transitive sets with a membership-only interface) and the no-junk internal forcing presentation; internal names and `M[G]` follow |
